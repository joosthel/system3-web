export default function Footer() {
    return (
      <footer className="border border-gray-400 p-4" id="footer">
        ...
        <div className="flex justify-center">
          <a href="mailto:mail@joosthelfers.com">
            <button className="hover:bg-gray-200 font-bold py-4 px-60 rounded text-xl">
              Write me an E-Mail!
            </button>
          </a>
        </div>  
