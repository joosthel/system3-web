...
export default function AIVideoCampaignPage() {
    return (
        <ProjectLayout
            ...
            description="From storyboard to edited campaign video — generative AI visual pipeline for a major consumer goods brand."
            date="2025-01-15"
        ...
        >
            <div className="space-y-12">
                <section>
                    <h2>The Brief</h2>
                    <p>
                        A global brand needed campaign videos showcasing new products, each scene based on a supplied storyboard. The challenge: AI-generated product visuals at this level need to be accurate enough for real campaign use — correct packaging, legible text, consistent product details across shots.
                    </p>
                </section>
                ...
                <section>
                    ...
                    <p>
                        Product and text consistency. Generative models have a strong tendency to hallucinate or smooth over fine details — exactly the details that matter most in branded content. Getting this right required a large number of controlled iterations, careful prompt engineering, and a precise understanding of how each model interprets reference imagery.
                    </p>
                </section>
